...
* :rocket: **Experiência recente:** Liderança de equipe no Hackathon de Nefrologia da Unesp e 2º lugar no Hacka PagBank (Hackeando a Experiência do cliente). Atuando no back-end de um projeto para a UFSCar - Campus Lagoa do Sino 
* :briefcase: **Buscando oportunidades** para atuar como Desenvolvedor Android e resolver problemas reais com código limpo.

### 🛠️ Tecnologias e Ferramentas

<p align="left">
  <img src="https://skillicons.dev/icons?i=kotlin,java,androidstudio,sqlite,firebase,git&theme=light" alt="Tecnologias e Ferramentas" />
</p>
